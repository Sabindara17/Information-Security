//Implementing Data Encryption Standard
//Generating a Key:
...
string left= perm_key.substr(0, 28); string right= perm_key.substr(28, 28); for(int i=0; i<16; i++){
...
int main(){
string key = "10101010101110110000100100011000001001110011" "01101100110011011101";
generate_keys(key);
}